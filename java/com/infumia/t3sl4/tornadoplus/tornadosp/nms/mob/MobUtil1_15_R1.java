...
public class MobUtil1_15_R1 implements IMobUtil {
    public Entity createEntity(EntityType entityType, World world) {
        WorldServer worldServer = ((CraftWorld)world).getHandle();
        //EntityLiving entity = (EntityLiving)EntityTypes.a.a(worldServer, new MinecraftKey(entityType.name().toLowerCase(Locale.ENGLISH)));
        //return entity.getBukkitEntity();
        return null;
    }

    public Entity spawnEntity(Entity entity, Location location) {
        net.minecraft.server.v1_15_R1.Entity craftEntity = ((CraftEntity)entity).getHandle();
