...
public class MobUtil1_10_R1 implements IMobUtil {
   public Entity createEntity(EntityType entityType, World world) {
      WorldServer worldServer = ((CraftWorld)world).getHandle();
      net.minecraft.server.v1_10_R1.Entity entity = EntityTypes.createEntityByName(entityType.name().toLowerCase(Locale.ENGLISH), worldServer);
      return entity.getBukkitEntity();
   }

   public Entity spawnEntity(Entity entity, Location location) {
      net.minecraft.server.v1_10_R1.Entity craftEntity = ((CraftEntity)entity).getHandle();
