...
public class Anvil1_8_R1 implements IAnvil {
   ...
   public Object newContainerAnvil(Player player) {
      return new Anvil1_8_R1.AnvilContainer(this.toNMS(player), (Anvil1_8_R1.AnvilContainer)null);
   }
   ...
   private class AnvilContainer extends ContainerAnvil {
      ...
      // $FF: synthetic method
      AnvilContainer(EntityPlayer var2, Anvil1_8_R1.AnvilContainer var3) {
         this(var2);
      }
   }
}
