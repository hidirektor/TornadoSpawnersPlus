...
public enum XMaterial {
   ...
   private XMaterial(int data, String... m) {
      this.m = m;
      this.data = data;
   }
   ...
   public static XMaterial requestXMaterial(String name, byte data) {
      if (cachedSearch.containsKey(name.toUpperCase() + "," + data)) {
         return (XMaterial)cachedSearch.get(name.toUpperCase() + "," + data);
      } else {
         XMaterial[] var5;
         int var4 = (var5 = values()).length;

         for(int var3 = 0; var3 < var4; ++var3) {
            XMaterial mat = var5[var3];
            String[] var9;
            int var8 = (var9 = mat.m).length;

            for(int var7 = 0; var7 < var8; ++var7) {
               String test = var9[var7];
   ...
   public boolean isSameMaterial(ItemStack comp) {
      if (isNewVersion()) {
         ...
         XMaterial xmat = this.fromMaterial(comp.getType());
   ...
   public XMaterial fromMaterial(Material mat) {
      try {
         ...
         for(int var4 = 0; var4 < var5; ++var4) {
            XMaterial xmat = var6[var4];
            String[] var10;
            int var9 = (var10 = xmat.m).length;

            for(int var8 = 0; var8 < var9; ++var8) {
               String test = var10[var8];
   ...
   public static XMaterial fromString(String key) {
      ...
      try {
         ...
         xmat = split.length == 1 ? requestXMaterial(key, (byte)0) : requestXMaterial(split[0], (byte)Integer.parseInt(split[1]));
         return xmat;
      }
   }
   ...
   public boolean isDamageable(XMaterial type) {
      if (type == null) {
         ...
         String var4;
         switch((var4 = split[length - 1]).hashCode()) {
         case -1850133582:
