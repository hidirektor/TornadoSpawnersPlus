...
public class MobUtil1_8_R2 implements IMobUtil {
   public Entity createEntity(EntityType entityType, World world) {
      WorldServer worldServer = ((CraftWorld)world).getHandle();
      net.minecraft.server.v1_8_R2.Entity entity = EntityTypes.createEntityByName(entityType.name().toLowerCase(Locale.ENGLISH), worldServer);
