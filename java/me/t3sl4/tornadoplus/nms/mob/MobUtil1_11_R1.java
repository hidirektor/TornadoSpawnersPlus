...
public class MobUtil1_11_R1 implements IMobUtil {
   public Entity createEntity(EntityType entityType, World world) {
      WorldServer worldServer = ((CraftWorld)world).getHandle();
      net.minecraft.server.v1_11_R1.Entity entity = EntityTypes.a(new MinecraftKey(entityType.name().toLowerCase(Locale.ENGLISH)), worldServer);
      return entity.getBukkitEntity();
   }

   public Entity spawnEntity(Entity entity, Location location) {
      net.minecraft.server.v1_11_R1.Entity craftEntity = ((CraftEntity)entity).getHandle();
   ...
   public Creature addTarget(List<EntityType> targets, Creature creature) {
      ...
      for(int i = 0; i < targets.size(); ++i) {
         ...
         MinecraftKey minecraftKey = new MinecraftKey(entityType.name().toLowerCase(Locale.ENGLISH));

         try {
            entityCreatureClass = (Class)EntityTypes.b.get(minecraftKey);
